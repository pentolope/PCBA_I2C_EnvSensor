...
#: The floor the fabrication requirements establish, restated as KiCad
#: design rules so DRC judges the board against the process that was
#: selected for it.
DESIGN_RULES = {
    "min_clearance": 0.125,
...
def project_document(root_sheet_uuid):
    return {
        ...
        "meta": {"filename": netlist.PROJECT_NAME + ".kicad_pro",
                 "version": 3},
        "net_settings": {
            "classes": [dict(DEFAULT_NET_CLASS, name="Default")],
        },
